...
\begin{itemize}
\item exposer et vulgariser la connaissance scientifique en machine
  learning
\item faire se rencontrer les différents acteurs, scientifiques et
  industriels du domaine du machine learning
\end{itemize}

Les moyens d'action de l'association \Nom{} sont notamment~:

\begin{itemize}
\item la tenue de réunions scientifiques
\item l'organisation d'un groupe de lecture
\end{itemize}
